...
It lets you edit the allowlist, view recent events, and browse recent images. You can
override the port with `GATE_WEB_PORT` in `/etc/gate_anpr.env`.
...
The web UI shows the RTSP camera stream via HLS.
...
GATE_WEB_STREAM_FPS=5
GATE_WEB_STREAM_WIDTH=1280
GATE_WEB_STREAM_HEIGHT=720
GATE_WEB_STREAM_ENCODER=libx264
```
